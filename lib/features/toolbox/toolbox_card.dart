      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              '${w.partOfSpeech} ${w.englishMeaning}',
              style: const TextStyle(
                fontSize: 13,
                fontWeight: FontWeight.w900,
                color: Colors.white,
          ...
          Row(
            ...
            children: [
              Container(
                ...
                child: Text(
                  context.l10n.exampleSentencePinyin,
                  style: const TextStyle(
                    fontSize: 11,
                    fontWeight: FontWeight.w900,
                    color: AppColors.morandiText,
      ...
      children: [
        Expanded(
          child: _buildToggleBtn(
            context.l10n.associatedWords,
            _showRelated,
            () => setState(() => _showRelated = true),
          ),
        ),
        const SizedBox(width: 16),
        Expanded(
          child: _buildToggleBtn(
            context.l10n.phrases,
            !_showRelated,
            () => setState(() => _showRelated = false),
          ),
        ),
      ],
    );
          ...
          child: Text(
            ...
            style: TextStyle(
              ...
              color: active
                  ...
                  : AppColors.shark40.withValues(alpha: 0.5),
            ),
          ),
        ),
      ),
  ...
  Widget _buildRelatedSection() {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildCategoryTag(context.l10n.synonyms, AppColors.baliHai30),
          const SizedBox(height: 12),
          ...
          const SizedBox(height: 16),
          _buildCategoryTag(context.l10n.antonyms, AppColors.oldRose15),
          const SizedBox(height: 12),
          ...
          const SizedBox(height: 16),
          _buildCategoryTag(
            context.l10n.expandedWords,
            AppColors.lavenderPurple.withValues(alpha: 0.3),
          ),
          const SizedBox(height: 12),
  ...
  Widget _buildPhraseSection() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildCategoryTag(context.l10n.phrases, AppColors.straw14),
          const SizedBox(height: 12),
        ...
        Expanded(
          child: Pressable(
            ...
            child: Container(
              ...
              child: Center(
                child: Text(
                  isLast ? context.l10n.finish : '${context.l10n.next} →',
                  style: const TextStyle(
                    fontSize: 15,
                    fontWeight: FontWeight.w900,
                    color: AppColors.morandiText,
